...
##############################################
# Local variables for IAM policies
##############################################
locals {
  policies = [
...
##############################################
# NETWORKING RESOURCES (VPC, Subnets, IGW, Route Table)
##############################################
...
##############################################
# EKS RESOURCES (Cluster, Node Group, SG, Rules)
##############################################
...
# Rules for Jenkins and general access
...
##############################################
# IAM RESOURCES (Roles, Policies, Attachments)
##############################################
# EKS Cluster role
...
##############################################
# Enable IMDS on EC2 nodes (for optional metadata usage)
##############################################
